...
interface ButtonProps extends Omit<HTMLMotionProps<'button'>, 'children'> {
  variant?: 'primary' | 'secondary' | 'cosmic' | 'gold' | 'ghost' | 'outline';
  size?: 'sm' | 'md' | 'lg';
  isLoading?: boolean;
...
const variants = {
  ...
  cosmic: 'bg-gradient-to-r from-cosmic-navy via-cosmic-purple to-secondary-600 text-white shadow-lg hover:shadow-xl',
  gold: 'bg-gradient-to-r from-gold-light via-gold to-gold-dark text-white shadow-lg hover:shadow-xl',
