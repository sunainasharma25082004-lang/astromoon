    ...
    <section className="py-20 bg-gradient-to-br from-cosmic-navy via-cosmic-purple to-cosmic-light relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 relative">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="text-white/80 text-lg mb-10">Get personalized guidance on career, relationships, and life.</motion.p>
          ...
          <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.4 }} className="text-white/60 text-sm mt-8">First consultation? Get ₹100 bonus on signup!</motion.p>
        </div>
      </div>
    </section>
  );
