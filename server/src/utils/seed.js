...
const seed = async () => {
  try {
    ...
    await Content.insertMany([
      ...
      { type: 'banner', title: 'Top Rated Astrologers', content: 'Connect with 4.8+ rated experts for accurate guidance.', image_url: 'https://images.pexels.com/photos/266026/pexels-photo-266026.jpeg?auto=compress&cs=tinysrgb&w=1200', link_url: '/astrologers?category=top-rated', sort_order: 2 },
      { type: 'banner', title: 'Get ₹100 Signup Bonus', content: 'Register today and get instant wallet credit.', image_url: 'https://images.pexels.com/photos/266026/pexels-photo-266026.jpeg?auto=compress&cs=tinysrgb&w=1200', link_url: '/auth/register', sort_order: 3 },
    ...
    await Product.insertMany([
      { name: 'Original Yellow Sapphire (Pukhraj) - 5.25 Ratti', category: 'Gemstones', price: 15000, original_price: 18000, images: ['https://images.pexels.com/photos/266026/pexels-photo-266026.jpeg?auto=compress&cs=tinysrgb&w=600'], stock: 25, rating: 4.8, total_reviews: 45, short_description: 'Certified natural Pukhraj for Jupiter' },
      ...
      { name: 'Blue Sapphire (Neelam) - 4.5 Ratti', category: 'Gemstones', price: 22000, original_price: 25000, images: ['https://images.pexels.com/photos/266026/pexels-photo-266026.jpeg?auto=compress&cs=tinysrgb&w=600'], stock: 15, rating: 4.6, total_reviews: 34 },
      ...
      { name: 'Red Coral (Moonga) - 6 Ratti', category: 'Gemstones', price: 8500, original_price: 10000, images: ['https://images.pexels.com/photos/266026/pexels-photo-266026.jpeg?auto=compress&cs=tinysrgb&w=600'], stock: 20, rating: 4.5, total_reviews: 28 },
    ]);
